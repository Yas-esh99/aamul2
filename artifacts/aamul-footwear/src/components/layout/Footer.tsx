...
const socialLinks = [
  ...
  { label: "Instagram", href: "https://www.instagram.com/aamul.footwear/", icon: Instagram, hoverColor: "hover:bg-gradient-to-br hover:from-[#833ab4] hover:via-[#fd1d1d] hover:to-[#fcb045]" },
    ...
    <footer className="bg-foreground text-background border-t border-border/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="bg-background/10 rounded-xl p-1.5">
                <img src={logoUrl} alt="Aamul Footwear" className="h-10 w-auto invert brightness-200" />
              </div>
              <div>
                <p className="font-display text-base font-bold leading-tight">Aamul Footwear</p>
                <p className="text-[10px] text-background/50 tracking-widest uppercase">Since 1990</p>
              </div>
            </div>
            <p className="text-background/65 text-sm leading-relaxed mb-5">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {socialLinks.map(({ label, href, icon: Icon, hoverColor }) => (
                <a
                  ...
                  aria-label={label}
                  className={`w-9 h-9 rounded-full bg-background/10 flex items-center justify-center transition-all duration-200 ${hoverColor} hover:text-white hover:scale-110`}
                >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display text-base font-semibold mb-4 text-background">Explore</h4>
            <ul className="space-y-2.5">
              <li><Link href="/" className="text-background/65 hover:text-background transition-colors text-sm">All Products</Link></li>
              <li><Link href="/handmade-mojdi" className="text-background/65 hover:text-background transition-colors text-sm">Handmade Mojdi ✨</Link></li>
              <li><Link href="/about" className="text-background/65 hover:text-background transition-colors text-sm">Our Story</Link></li>
            </ul>

            <h4 className="font-display text-base font-semibold mt-7 mb-4 text-background">Contact</h4>
            <ul className="space-y-3">
              <li>
                <a href="tel:9879098493" className="flex items-start gap-2 text-background/65 hover:text-background transition-colors text-sm">
                  <Phone className="w-3.5 h-3.5 mt-0.5 shrink-0" />
                  <span>9879098493 | 7862967076</span>
                </a>
              </li>
              <li>
                <a href="mailto:aamulfootwear@gmail.com" className="flex items-start gap-2 text-background/65 hover:text-background transition-colors text-sm">
                  <Mail className="w-3.5 h-3.5 mt-0.5 shrink-0" />
                  <span>aamulfootwear@gmail.com</span>
                </a>
              </li>
              <li>
                <a href="https://maps.app.goo.gl/J2E5NxG6Xaa2Acmz9" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2 text-background/65 hover:text-background transition-colors text-sm">
          ...
          <div className="lg:col-span-2">
            <h4 className="font-display text-base font-semibold mb-4 text-background">Product Categories</h4>
      ...
      {/* Bottom bar */}
      <div className="border-t border-background/10 py-5 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-background/40">
